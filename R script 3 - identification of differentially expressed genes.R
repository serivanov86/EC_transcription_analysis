...
fit2 <- eBayes(fit2)
deg <- topTable(fit2, coef="EC1 - HIVneg", n=500000, sort.by="p")
...
fit2 <- contrasts.fit(fit, contrast.matrix)
fit2 <- eBayes(fit2)
deg <- topTable(fit2, coef="AI1 - HIVneg", n=500000, sort.by="p")
...
fit2 <- contrasts.fit(fit, contrast.matrix)
fit2 <- eBayes(fit2)
deg <- topTable(fit2, coef="CI - HIVneg", n=500000, sort.by="p")
...
fit2 <- contrasts.fit(fit, contrast.matrix)
fit2 <- eBayes(fit2)
deg <- topTable(fit2, coef="AI2 - HIVneg", n=500000, sort.by="p")
